  ...
  return (
    <>
      <div className="game-ui">
        <div className="top-link pt-2 d-flex justify-content-between align-items-center">
          <ul>
            <li>
            <img src="/images/signl.png"/></li>
            <li>
            <img src="/images/mesage.png"/></li>
            <li>
            <img src="/images/ico2.png"/></li>
            <li>
            <img src="/images/ico3.png"/></li>
            <li>
            <img src="/images/spo.png"/></li>
      ...
      <div class="input-group mb-2">
        <div class="input-group-prepend">
          <div class="input-group-text"><img src="/images/bal.png" className="balance"/></div>
        </div>
        <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Balance"/>
      </div>
      <img src="/images/dep.png" className="balance me-2"/>
        ...
        <div className="game-play container-fluid">
          
          <Row>
            <Col sm={3} lg={3} md={3} className="">
              <div className="box-1">
                <div className="dollar d-flex justify-content-center align-items-center">
                  <h5 className="mb-0">$</h5>
                  <h4 className="mb-0">434K</h4>
                </div>
              </div>
            </Col>
            <Col sm={6} lg={6} md={6} className="camera-img">
              ...
              <div className="live-camera d-flex justify-content-center align-items-center">
                <h3 className="text-center p-4">Live is going to start please wait...</h3>
              </div>
            </Col>
            <Col sm={3} lg={3} md={3} className="image2">
              <div className="box-2">
                <div className="dollar2 d-flex justify-content-center align-items-center">
                  <h5 className="mb-0">$</h5>
                  <h4 className="mb-0">434K</h4>
                </div>
              </div>
          ...
          <Row className="mt-3">
            <Col sm={3} lg={3} md={3} className="image-btm">
              <div className="box-3">
                <div className="dollar3 d-flex justify-content-center align-items-center">
                  <h5 className="mb-0">$</h5>
                  <h4 className="mb-0">434K</h4>
                </div>
              </div>
            </Col>
            <Col sm={3} lg={3} md={3} className="image-btm2">
              <div className="box-4">
                <div className="dollar3 d-flex justify-content-center align-items-center">
                  <h5 className="mb-0">$</h5>
                  <h4 className="mb-0">434K</h4>
            ...
            <Col sm={3} lg={3} md={3} className="image-btm3">
              <div className="box-5">
                <div className="dollar3 d-flex justify-content-center align-items-center">
                  <h5 className="mb-0">$</h5>
                  <h4 className="mb-0">434K</h4>
            ...
            <Col sm={3} lg={3} md={3} className="image-btm4">
              <div className="box-6">
                <div className="dollar6 d-flex justify-content-center align-items-center">
                  <h5 className="mb-0">$</h5>
                  <h4 className="mb-0">434K</h4>
                </div>
              </div>
